...
class BucketWriter {
  ...
  private final HDFSSink.WriterCallback onCloseCallback;
   ...
   * io.transwarp.demo.flume.sink.sink that owns it. This method should be used only when size or count
