...
public class ConnectorSingleton {
    ...
    public Connection getConnection(){
        ...
        try {
            if(Constant.mode.toLowerCase() == Constant.MODE.KERBEROS.key){
                connection = DriverManager.getConnection(Constant.configuration.get(Constant.kerberosJdbcUrl));
            }else if(Constant.mode.toLowerCase() == Constant.MODE.LDAP.key){
            ...
            }else if(Constant.mode.toLowerCase() == Constant.MODE.SIMPLE.key){
